...
<sub>Compared <code>a1b2c3d</code> with <code>3f2a9c1</code> · <a href="#github-action">job summary</a> · powered by <a href="https://github.com/shazow/go-whatchanged">go-whatchanged</a></sub>
</details>
...
jobs:
  api:
    ...
    steps:
      ...
      - uses: shazow/go-whatchanged@v1.0.0
```
